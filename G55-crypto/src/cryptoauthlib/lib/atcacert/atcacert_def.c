                               ...
                               size_t                       block_size)
{
    ...
    for (i = 0; i < *device_locs_count; ++i)
    {
        ...
        if (new_end > cur_end)
            cur_device_loc->count = new_end - cur_device_loc->offset;
        else
            cur_device_loc->count = cur_end - cur_device_loc->offset;
        break;
    }
    ...
    if (i == *device_locs_count)
    {
        ...
        device_locs[*device_locs_count].offset = new_offset;
        device_locs[*device_locs_count].count = new_end - new_offset;
        (*device_locs_count)++;
    }
